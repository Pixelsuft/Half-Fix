...
static void ide_atapi_run_command(struct ide_controller* ctrl)
{
    ...
    case 0x12: // Inquiry
        ...
        ide_pio_store_string(ctrl, "Half Fix", 8, 8, 0, 1);
        ide_pio_store_string(ctrl, "Falf Fix CD-ROM", 16, 16, 0, 1);
...
static void ide_identify(struct ide_controller* ctrl)
{
    ...
    if (cdrom) {
        ...
        ide_pio_store_string(ctrl, "Half Fix CD-ROM drive", 27 << 1, 40, 1, 1);
...
#define NOT_TRANSLATED(obj, field) obj->field[obj->selected << 1]
        ...
        ide_pio_store_string(ctrl, "HALF FIX", 27 << 1, 40, 1, 1);
